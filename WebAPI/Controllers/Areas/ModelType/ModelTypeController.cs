...
namespace WebAPI.Controllers.Areas.ModelType
{
    [ApiController]
    [Route("api/WebAPI/[controller]/[action]")]
    public class ModelTypeController : Controller
    {
        private readonly IModelTypeUseCase _useCase;

        public ModelTypeController(IModelTypeUseCase useCase)
        {
            _useCase = useCase;
        }

        [HttpPost]
        public async Task<IActionResult> Create(ModelTypeCreateDTO dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(ModelTypeUpdateDTO dto)
        {
